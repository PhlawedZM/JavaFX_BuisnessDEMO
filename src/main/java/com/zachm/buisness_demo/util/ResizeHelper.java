 ...
 *
 * 12/10/23: Made it scalable so on bigger screens it isn't 4 px. Added a condition so it doesn't function in fullscreen
 * The big change is that I added a filter for dragging
 *
 * Original on 6/13/14.
 * Updated on 8/15/17.
 * Updated on 12/19/19.
...
public class ResizeHelper {
    ...
    /**
     * Use this in your Controller Initializer function
     */
    public static void setDragFilter(Region region) {
        filter = region.getId();
        region.setOnMousePressed(event -> region.setOnMouseDragged(d_event -> {
        }));
    }
    ...
    static class ResizeListener implements EventHandler<MouseEvent> {
        ...
        public void handle(MouseEvent mouseEvent) {
            ...
            double border = Math.ceil(stage.getHeight()/256);
            ...
            if (MouseEvent.MOUSE_DRAGGED.equals(mouseEventType) && Cursor.DEFAULT.equals(cursorEvent) && !resizing) {
                if(mouseEvent.getSource() instanceof Region region && region.getId() == filter) {
